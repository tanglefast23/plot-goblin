        ...
        <Link className={styles.brand} href="/">
          ...
          >
            ...
            <path
              ...
              d="M26 54c7-6 23-6 30 0 4 4 3 16-2 20-6 5-20 5-26 0-5-4-6-16-2-20Zm46 0c7-6 23-6 30 0 4 4 3 16-2 20-6 5-20 5-26 0-5-4-6-16-2-20Zm-16 8h16"
              data-mascot-part="glasses"
            />
            <path className={styles.smirk} d="M50 72c10 5 21 5 31-1" />
            <path className={styles.tooth} d="M62 73 67 82l6-10Z" data-mascot-part="fang" />
          </svg>
